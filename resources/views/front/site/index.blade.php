@section('title',__('site.catchprase'))
        ...
        <div class="container">
            <div class="row home-row">
                <div class="col-12 d-block d-md-none">
                    <a href="#">
                        <img alt="galon pusing" class="mobile-hero rounded" src="{{asset('images/landing-page/galon-pusing.png')}}" />
                    </a>
                </div>

                <div class="col-12 col-xl-4 col-lg-5 col-md-6">
                    <div class="home-text">
                        <div class="display-1">{{__('site.catchprase')}}</div>
                        <p class="white mb-5">
                            {{__('site.description')}}
                        </p>
                        <a class="btn btn-outline-semi-light btn-xl" href="{{route('register')}}">{{__('site.call_to_action')}}</a>
                    </div>
                </div>
                <div class="col-12 col-xl-7 offset-xl-1 col-lg-7 col-md-6  d-none d-md-block">
                    <a href="#">
                        <img class="rounded" alt="galon pusing" src="{{asset('images/landing-page/galon-pusing.png')}}" />
                    </a>
                </div>
            </div>
                ...
                <div class="row footer-row">
                    ...
                    <div class="col-12 text-center footer-content">
                        <a href="{{route('landing.index')}}">
                            <img class="footer-logo" alt="footer logo" src="images/landing-page/logo-footer.svg" />
                        </a>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-xs-6 col-sm-3 offset-0 col-lg-2 offset-lg-2 footer-menu mb-5">
                        <div class="d-flex flex-column align-items-center">
                            <a href="#" class="d-inline-block d-xs-none collapse-button mb-1" data-toggle="collapse" data-target="#menuGroup1"
                               aria-expanded="true">COMPANY <i class="icon-arrow-down"></i></a>
                    ...
                    <div class="col-12 col-xs-6 col-sm-3 col-lg-2 footer-menu mb-5">
                        <div class="d-flex flex-column align-items-center">
                            <a href="#" class="d-inline-block d-xs-none collapse-button mb-1" data-toggle="collapse" data-target="#menuGroup2"
                               aria-expanded="true">PRODUCT <i class="icon-arrow-down"></i></a>
                    ...
                    <div class="col-12 col-xs-6 col-sm-3 col-lg-2 footer-menu mb-5">
                        <div class="d-flex flex-column align-items-center">
                            <a href="#" class="d-inline-block d-xs-none collapse-button mb-1" data-toggle="collapse" data-target="#menuGroup3"
                               aria-expanded="true">LEARNING <i class="icon-arrow-down"></i></a>
                    ...
                    <div class="col-12 col-xs-6 col-sm-3 col-lg-2 footer-menu mb-5">
                        <div class="d-flex flex-column align-items-center">
                            <a href="#" class="d-inline-block d-xs-none collapse-button mb-1" data-toggle="collapse" data-target="#menuGroup4"
                               aria-expanded="true">LEGAL <i class="icon-arrow-down"></i></a>
